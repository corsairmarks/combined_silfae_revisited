...
I was inspired to extend the original mod when I saw Endugu's extension of Silfae's Animated Xirmian Portraits.  Modular mods that require downloading the original mod(s) help give credit where credit is due.

An extre special thanks to Silfae for creating and sharing so many animated portraits with the community.