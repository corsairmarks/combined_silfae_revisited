...
* The Saurischians are part of the Reptilian species class (since Stellaris 3.8)
...
* 7.0.0 Update for Stellaris version 3.8 "Gemini"
    * Saurischians are now part of the Reptilian species class (thanks to changes by Paradox, this is no longer mod-unfriendly)
